"""
DocumentType schemas — Pydantic v2 contracts for CRUD API.
"""
...
class DocumentTypeCreate(BaseModel):
    """Create a new document type (invoice, receipt, letter, etc.)."""
...
class DocumentTypeResponse(BaseModel):
    """DocumentType API response with document count."""

    id: int = Field(description="Document type ID")
