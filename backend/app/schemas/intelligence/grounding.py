...
class EvidenceChunk(BaseModel):
    ...
    # Sprint 2 image routing — populated only for image chunks from synapse_dense
    content_type: str = Field("text", description="Chunk media type: 'text' or 'image'")
    storage_path: Optional[str] = Field(None, description="Absolute disk path for image chunks")
