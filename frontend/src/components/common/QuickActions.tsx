...
import { MessageSquare, BookOpen, FileQuestion, FileText, MoreHorizontal } from 'lucide-react';
...
export function QuickActions({ resourceType, resourceId, resourceTitle, className }: QuickActionsProps) {
    ...
    return (
        <SimpleDropdownMenu
            trigger={
                <button className={`synapse-icon-button ${className}`} title="Quick Actions">
