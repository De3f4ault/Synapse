...
function getStatusConfig(status: StatusType): {
  ...
  const configs: Record<StatusType, ReturnType<typeof getStatusConfig>> = {
    ...
    success: {
      ...
      textColor: "text-green-700 dark:text-accent-olive",
    },
    error: {
      label: "Error",
      icon: XCircle,
    ...
    warning: {
      ...
      textColor: "text-amber-700 dark:text-warning",
    },
    info: {
      label: "Info",
      icon: Info,
      bgColor: "bg-info/10",
      textColor: "text-blue-700 dark:text-info",
    },
    pending: {
      label: "Pending",
      icon: Clock,
      bgColor: "bg-slate-500/10",
      textColor: "text-foreground/70 dark:text-muted-foreground",
      pulse: true,
    },
    processing: {
      label: "Processing",
