    ...
    renderDefaultFallback(level: ErrorBoundaryLevel) {
        ...
        if (level === "module") {
            return (
                ...
                <p className="mb-3">
                {error?.message || "An error occurred while loading this section. Please try again."}
                </p>
                <Button
                variant="outline"
                size="sm"
        ...
        return (
            <div className={cn("py-2 px-3 rounded-md bg-destructive/10 border border-destructive/20", this.props.className)}>
