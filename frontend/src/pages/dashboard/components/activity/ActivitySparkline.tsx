...
export function ActivitySparkline() {
  ...
  if (isLoading)
    return (
      <div className="dashboard-glass h-48 flex items-center justify-center">
        <LoadingState />
      </div>
    );
  ...
  return (
    <div className="dashboard-glass rounded-2xl p-6 relative overflow-hidden group h-full flex flex-col">
      ...
      <div className="flex-1 relative w-full min-h-[100px]">
        ...
        {/* Labels */}
        <div className="absolute bottom-0 left-2 translate-y-5 text-[9px] text-slate-600 font-mono">
          T-30
        </div>
        <div className="absolute bottom-0 right-0 translate-y-5 text-[9px] text-slate-600 font-mono">
          NOW
        </div>
      </div>
    </div>
