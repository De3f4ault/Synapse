                        ...
                        {aiAnalysis ? (
                            <div className="bg-cyan-950/20 border border-cyan-500/20 rounded-xl p-4 text-left">
                                <div className="flex items-center gap-2 mb-2 text-cyan-400">
                                    ...
                                    <h3 className="font-bold text-[10px] uppercase tracking-wider">AI Insight</h3>
                                </div>
                ...
                <div className="h-full overflow-y-auto bg-[#020408]">
                    <div className="max-w-4xl mx-auto p-6 pt-24 pb-20">
                        <div className="flex items-center justify-between mb-8">
                            <div>
                                <h2 className="text-3xl font-bold text-white mb-2">Detailed Review</h2>
                                <p className="text-slate-400">Analyze your answers to improve retention</p>
                            </div>
                        ...
                        <div className="space-y-4">
                            {results.answers?.map((answer: any, idx: number) => {
                                const question = attemptData.questions.find(q => q.id === answer.question_id);
                                return (
                                    <QuestionReview
                                        key={idx}
