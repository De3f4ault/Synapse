...
export const KnowledgeSidebar: React.FC<KnowledgeSidebarProps> = ({
    ...
    return (
        <div className={`w-80 flex flex-col gap-6 p-6 border-r border-white/5 bg-slate-900/50 backdrop-blur-xl ${className}`}>
            {/* Header */}
            ...
            <div className="p-4 rounded-xl bg-slate-800/30 border border-white/5">
                <p className="text-xs text-slate-400 leading-relaxed text-center">
                    Use <kbd className="px-1.5 py-0.5 rounded bg-slate-700 text-slate-200 font-mono">Shift</kbd> + Drag to select multiple nodes, or Double Click to navigate to a specific item.
                </p>
            </div>
        </div>
    );
