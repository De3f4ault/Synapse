 ...
 */
export const ChunkExplorer: React.FC<ChunkExplorerProps> = ({ chunks, documentId }) => {
    ...
    return (
        ...
        <Badge variant="outline" className="bg-cyan-950/30 text-cyan-400 border-cyan-500/30">
