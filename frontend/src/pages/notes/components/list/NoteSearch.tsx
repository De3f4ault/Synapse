...
export const NoteSearch: React.FC<NoteSearchProps> = ({
    ...
    return (
        ...
        {isFocused && !value && (
            ...
            >
            <Sparkles size={12} className="text-[var(--synapse-text-dim)] group-hover/ai:text-[var(--synapse-cyan)] transition-colors" />
            </motion.button>
        )}
        </AnimatePresence>
        ...
        {value && (
            ...
            title="Clear search"
            >
            <X size={12} className="text-[var(--synapse-text-dim)] group-hover/clear:text-[var(--synapse-red)] transition-colors" />
            </motion.button>
        )}
        </AnimatePresence>
