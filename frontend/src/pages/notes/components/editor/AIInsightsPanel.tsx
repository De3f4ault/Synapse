    ...
    return (
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    <NeumorphicCard
                        className="h-full flex flex-col rounded-t-3xl rounded-b-none border-b-0 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] bg-[#0a0a0f]/95 backdrop-blur-xl"
                        noPadding
                    >
                        {/* Header */}
                        <div
                            className="flex items-center justify-between px-6 py-4 border-b border-white/5 cursor-pointer hover:bg-white/5 transition-colors rounded-t-3xl"
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <span className="px-2 py-0.5 bg-purple-500/10 text-purple-400 rounded-md text-xs font-mono border border-purple-500/20">
                                    {insights.length}
                                </span>
                            </div>
                                    ...
                                    insights.map((insight, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-start justify-between mb-4">
                                                <div className="flex items-center gap-2">
                                                    {insight.type === 'summary' && <Sparkles size={16} className="text-purple-400" />}
                                                    {insight.type === 'tags' && <Tags size={16} className="text-cyan-400" />}
                                                    {insight.type === 'suggestions' && <Lightbulb size={16} className="text-amber-400" />}
                                            ...
                                            {/* Insight Content */}
                                            <div className="prose prose-sm prose-invert max-w-none mb-4 prose-p:text-slate-400 prose-li:text-slate-400">
