...
import { useRecommendations, useLearningPaths } from '../../hooks/useRecommendations';
...
export function Recommendations({ limit, onStartSession }: RecommendationsProps) {
    ...
    const handleStartSelected = () => {
        const selected = recommendations.filter(item => selectedItems.includes(item.id));
