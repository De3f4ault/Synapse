                        ...
                        <div className="mb-6 flex items-center justify-between">
                            <div>
                                <span className={cn(
                                    ...
                                    {activeSession.type === 'due' ? 'Review Session' : 'AI Recommendation'}
                                </span>
                                <h1 className="text-3xl font-bold text-white mt-2">Study Session</h1>
                            </div>
                            <div className="text-right">
                                <div className="text-2xl font-mono font-bold text-white">{activeSession.items.length}</div>
                                <div className="text-xs text-slate-500 uppercase tracking-wider">Items</div>
                            </div>
                        </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 shrink-0">
                ...
                <div className="flex items-center gap-4 bg-white/5 border border-white/5 px-4 py-2 rounded-xl">
                    <div className="text-right">
                        ...
                        <div className="text-xl font-bold text-cyan-400 font-mono">{streak.current} <span className="text-sm text-slate-500">days</span></div>
                    </div>
