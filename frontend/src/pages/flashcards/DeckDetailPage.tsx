...
import {
    ArrowLeft, Play, Plus, Brain, Layers, Sparkles,
    TrendingUp, Target, Activity, Wand2, BookOpen, BarChart3,
    ChevronRight, Star, Flame, Edit, Trash2
} from 'lucide-react';
...
function StatCard({
    ...
    return (
        <NeumorphicCard className="p-5 text-center flex flex-col justify-center items-center h-32">
            <div className={cn("w-10 h-10 rounded-full nm-inset flex items-center justify-center mb-3", colorClasses[color])}>
...
function CardItem({
    ...
    const stateColors: Record<LearningState, { variant: 'cyan' | 'purple' | 'emerald' | 'coral' }> = {
        new: { variant: 'purple' },
                ...
                <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-2">
                            <NeumorphicBadge variant="outline" color={colorConfig.variant} className="text-[10px]">
                                {card.learning_state}
                            </NeumorphicBadge>
        ...
        return (
            <div className="min-h-screen nm-bg nm-constellation-bg flex items-center justify-center">
                <NeumorphicCard className="p-12 flex flex-col items-center text-center max-w-md">
                    ...
                    <p className="text-slate-400 mb-6">The requested deck could not be located.</p>
                    <NeumorphicButton onClick={() => navigate('/flashcards')} variant="primary">
            ...
            >
                ...
                <motion.div variants={itemVariants} className="flex items-center gap-4">
                    ...
                    <div className="text-sm text-slate-500 font-mono">
                        <span className="hover:text-cyan-400 cursor-pointer" onClick={() => navigate('/flashcards')}>
                            Flashcards
                        </span>
                            ...
                            <div className="p-4 max-h-[500px] overflow-y-auto scrollbar-hide">
                                {cardsLoading ? (
                                    ...
                                    >
                                        ...
                                        <p className="text-slate-500 text-sm mb-6">Create your first card to begin</p>
                                        <NeumorphicButton
                                            variant="primary"
                                            onClick={() => navigate(`/flashcards/${id}/cards/new`)}
                                        >
