    ...
    <Card className="bg-[rgba(10,10,10,0.6)] backdrop-blur-xl border-white/5">
      ...
      <CardContent className="space-y-4 text-slate-300">
        <p className="text-sm leading-relaxed">
          The Mnemosyne Protocol uses an advanced{" "}
          <strong>SuperMemo 2 (SM-2)</strong> spaced repetition algorithm to
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Review intervals adjust based on your performance. Master a
                card, and the system extends the time until your next review.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Cards are presented just before you're likely to forget them,
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Your ratings (Again, Hard, Good, Easy) fine-tune the algorithm,
        ...
        <div className="mt-6 p-4 bg-cyan-500/10 border border-cyan-500/30 rounded-lg">
          <p className="text-xs font-mono text-cyan-300 leading-relaxed">
            <strong>Pro Tip:</strong> Review daily for optimal results. The
            algorithm works best with consistent engagement—even 10 minutes a
            day yields dramatic improvements.
          </p>
        </div>
      </CardContent>
    </Card>
