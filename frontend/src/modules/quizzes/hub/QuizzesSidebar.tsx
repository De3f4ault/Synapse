import { Filter, Hash, Clock, Plus, Layers, FileQuestion } from "lucide-react";
...
export const QuizzesSidebar = ({
    ...
    // Placeholder categories/sectors for now, can be dynamic later
    const categories = ["All", "Science", "History", "Technology", "Pyschology"]; 
        ...
        >
            ...
            <div className="p-4 flex flex-col gap-4 shrink-0">
                <div className={cn("flex items-center gap-2 transition-opacity duration-200", isCollapsed ? "justify-center" : "")}>
                    <FileQuestion className={cn("text-cyan-400 transition-all", isCollapsed ? "w-8 h-8" : "w-5 h-5")} />
                    {!isCollapsed && (
                        <h2 className="text-xl font-bold text-white whitespace-nowrap">Quizzes</h2>
                    )}
                </div>
