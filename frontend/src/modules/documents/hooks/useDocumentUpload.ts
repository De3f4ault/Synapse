...
export function useDocumentUpload(options?: UseDocumentUploadOptions) {
    ...
    const uploadMutation = useMutation({
        mutationFn: async (file: File) => {
            ...
            try {
                ...
                const response = await DocumentsService.uploadDocumentApiV1DocumentsUploadPost(formData);
    ...
    const processingStatusQuery = useQuery<ProcessingStatusResponse>({
        ...
        queryFn: async () => {
            ...
            return DocumentsService.getProcessingStatusApiV1DocumentsDocumentIdStatusGet(uploadedDocumentId);
        },
...
export function useProcessingStatus(documentId: number | null) {
    return useQuery<ProcessingStatusResponse>({
        ...
        queryFn: async () => {
            ...
            return DocumentsService.getProcessingStatusApiV1DocumentsDocumentIdStatusGet(documentId);
        },
        enabled: !!documentId,
        refetchInterval: (query) => {
            const data = query.state.data;
