/**
 * Notes Module - Selection Engine
 * Text selection and manipulation utilities for textarea editors.
 *
 * MIGRATED FROM: pages/notes/utils/textSelection.ts
 */
 ...
 */
export function getCurrentLine(element: HTMLTextAreaElement): LineInfo {
    const value = element.value;
